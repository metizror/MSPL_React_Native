...
import { containerMargin, containerSize, imageSize } from "../Utils/Helper";
  ...
  return (
    <Pressable
      ...
      style={{
        ...
        flex: 1,
       height:  verticalScale(containerSize(index)),
       marginTop: containerMargin(index)
      }}
    >
      <FastImage
        style={{
          overflow: "hidden",
          height: verticalScale(imageSize(index)),
